...
# Define input and output directories and Open Babel executable path
input_dir = r'C:\Users\heman\OneDrive\Desktop\coconut_200\xyz'
output_dir = r'C:\Users\heman\OneDrive\Desktop\coconut_200\sdf'
obabel_path = r'C:\Program Files\OpenBabel-3.1.1\obabel.exe'  # Ensure this path is correct
